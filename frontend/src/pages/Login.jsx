  ...
  return (
    <div className="min-h-screen bg-[#090d16] text-slate-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md z-10 px-4 sm:px-0">
        ...
        <div className="mt-6 p-4 rounded-xl bg-blue-950/40 border border-blue-800/40 flex items-center justify-between gap-3 text-left">
          ...
          <Link
            to="/detect"
            className="text-xs font-semibold text-blue-400 hover:text-blue-300 shrink-0 inline-flex items-center gap-1 group"
          >
            <span>Scan Now</span>
