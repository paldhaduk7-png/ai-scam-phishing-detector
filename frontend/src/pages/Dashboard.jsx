...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-5 sm:space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-5 rounded-2xl bg-[#0d1424] border border-slate-800/60 shadow-sm">
        <div className="flex items-center gap-3.5 sm:gap-4 min-w-0">
          {user?.profile_photo ? (
            <div className="relative shrink-0">
              ...
              />
              <span
                className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-emerald-500 border-2 border-[#0d1424] rounded-full shadow-sm"
        ...
        <div className="flex items-center gap-2.5 self-start sm:self-center shrink-0">
          <button
            ...
            className="px-3.5 py-2 text-xs font-semibold text-slate-300 bg-slate-800/60 hover:bg-slate-700/60 rounded-xl border border-slate-700/60 transition-colors flex items-center gap-1.5 cursor-pointer shadow-sm"
          >
      ...
      {activeGmailJob && ['starting', 'processing'].includes(activeGmailJob.status) && (
        <div className="p-3.5 sm:p-5 rounded-2xl bg-gradient-to-r from-emerald-950/40 via-blue-950/30 to-indigo-950/40 border border-emerald-800/40 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 animate-fadeIn">
          ...
          <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
            <button
              ...
              className="px-3 py-1.5 text-xs font-semibold text-blue-400 bg-slate-900/60 hover:bg-blue-950/40 rounded-xl border border-slate-800/60 transition-colors shadow-sm cursor-pointer"
            >
              View Progress
            </button>
            <button
