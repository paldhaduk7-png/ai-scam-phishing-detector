    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <Card className="p-8">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 flex items-center gap-4 shrink-0 shadow-xs">
            ...
            <div>
              <p className="text-base font-extrabold text-blue-950">Stay Aware</p>
              <p className="text-base font-extrabold text-blue-700">Stay Safe</p>
            </div>
          </div>
        </div>
      </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          {steps.map((step, idx) => (
            <div key={idx} className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 font-bold text-base flex items-center justify-center shrink-0">
                {step.num}
              </div>
              ...
              {idx < steps.length - 1 && (
                <div className="hidden md:flex items-center text-slate-300 ml-auto self-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {technologies.map((tech, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-4 rounded-xl border border-slate-100 bg-slate-50/60 hover:bg-slate-50 transition-all flex flex-col items-center text-center group"
              >
                <div
