  ...
  return (
    <Card className="h-full flex flex-col justify-between relative overflow-hidden">
      <div>
        <div className="flex items-center justify-between pb-3 border-b border-slate-100 mb-3">
          <div className="flex items-center gap-2">
            <h2 className="text-base font-bold text-slate-900">Safety Tips</h2>
          </div>
          <button
            type="button"
      ...
      <div className="mt-4 pt-3 border-t border-slate-50 flex items-center justify-end">
        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-amber-50 text-amber-700 text-xs font-medium border border-amber-200/60">
