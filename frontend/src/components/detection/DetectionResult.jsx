...
export default function DetectionResult({
  ...
  if (status === 'success' && result) {
    const classification = result.classification || 'Scan Complete';
    ...
    const guidance = isPhishing
      ? [
          ...
          'Block the sender or blacklist the suspicious web domain.',
        ]
      : isSuspicious
      ? [
          'Verify sender details via an official trusted channel before replying.',
          'Check browser URL bar carefully for character spoofing.',
        ]
      : [
