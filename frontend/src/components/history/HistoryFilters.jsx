...
export default function HistoryFilters({
  ...
  return (
    <Card className="p-3.5 sm:p-5 space-y-2.5 sm:space-y-3">
      ...
      {channel === 'email' && (
        <div className="flex items-center gap-1 p-1 bg-slate-100 dark:bg-[#0b111e] rounded-xl max-w-xs border border-slate-200/80 dark:border-slate-800/80">
          <button
            type="button"
            onClick={() => setSourceFilter?.('all')}
            className={`flex-1 py-1.5 px-3 text-xs font-semibold rounded-lg transition-all cursor-pointer ${
              sourceFilter === 'all'
                ? 'bg-white dark:bg-slate-700/60 text-blue-600 dark:text-blue-400 shadow-xs dark:shadow-sm'
      ...
      <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-2.5 sm:gap-3 w-full">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-[#0b111e] border border-slate-200 dark:border-slate-800/80 rounded-xl text-xs sm:text-sm text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600/50 transition-all"
          />
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex items-center gap-2 sm:gap-2.5">
          ...
          {channel === 'all' && (
            <div className="relative sm:w-36 col-span-1">
              <select
                ...
                className="w-full appearance-none pl-2.5 sm:pl-3 pr-7 sm:pr-8 py-2 bg-slate-50 dark:bg-[#0b111e] border border-slate-200 dark:border-slate-800/80 rounded-xl text-xs font-semibold text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600/50 transition-all cursor-pointer"
              >
          ...
          <div className={`relative sm:w-36 ${channel === 'all' ? 'col-span-2 sm:col-span-1' : 'col-span-1'}`}>
            ...
            <input
              ...
              className="w-full pl-8 pr-2 py-1.5 bg-slate-50 dark:bg-[#0b111e] border border-slate-200 dark:border-slate-800/80 rounded-xl text-xs font-semibold text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600/50 transition-all cursor-pointer"
            />
          </div>
          ...
          {isFiltered && (
            <button
              type="button"
              onClick={handleReset}
              className="col-span-2 sm:col-span-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white bg-slate-100 dark:bg-slate-800/60 hover:bg-slate-200 dark:hover:bg-slate-700/60 border border-slate-200 dark:border-slate-700/60 rounded-xl transition-all cursor-pointer shadow-2xs"
            >
